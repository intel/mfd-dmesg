...
htmlhelp_basename = "mfd-dmesg-doc"
...
latex_documents = [
    (master_doc, "mfd-dmesg.tex", "MFD-Dmesg Documentation", "author", "manual"),
]
...
man_pages = [(master_doc, "mfd-dmesg", "MFD-Dmesg Documentation", [author], 1)]
